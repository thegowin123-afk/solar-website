...
export default function CountyPage() {
  ...
  const page = countyPages.find(
    (p) => p.slug === `solar-planning-${county}`
  );
  ...
  const localBusinessSchema = {
    ...
    description: `Solar planning application specialists for County ${page.county}, Ireland. Glint & glare analysis, LVIA reports, and PV planning drawings.`,
    url: pageUrl,
    areaServed: [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Expert solar planning application consultancy in Co. ${page.county}. Glint & glare analysis, LVIA reports, and PV planning drawings for ${page.county} solar projects. Accepted by ${page.county} County Council and An Bord Pleanála.`} />
        <link rel="canonical" href={pageUrl} />
        <meta property="og:title" content={`Solar Planning Application ${page.county} | SolarPlan Ireland`} />
        <meta property="og:description" content={`Expert solar planning application consultancy in Co. ${page.county}. Glint & glare, LVIA, PV drawings.`} />
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  SolarPlan Ireland has prepared planning documentation for solar projects across County {page.county}, working with local developers, farmers, and energy companies to navigate {page.county} County Council's planning requirements — and, where needed, An Bord Pleanála proceedings.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                <h2 className="text-xl font-heading font-bold text-forest-900 mb-4">
                  Why Local Planning Knowledge Matters
                </h2>
                <ul className="space-y-3">
                  {[
                    ...
                    'Landscape sensitivities vary significantly within the county — we know which areas require a more robust LVIA approach.',
