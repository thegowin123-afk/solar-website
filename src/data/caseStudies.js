export const caseStudies = [
  {
    id: 1,
    slug: 'midlands-solar-farm',
    title: 'Midlands Solar Farm — 45MW Ground-Mounted',
    county: 'Offaly',
  ...
  {
    id: 2,
    slug: 'agri-voltaic-connacht',
    title: 'Agri-voltaic Farm — Dual Land Use Design',
    county: 'Roscommon',
  ...
  {
    id: 3,
    slug: 'dublin-warehouse-portfolio',
    title: 'Dublin Logistics Portfolio — 7-Site Rooftop Rollout',
    county: 'Dublin',
    projectType: 'Commercial Rooftop',
    capacity: '8.4MW combined',
    services: ['Roof-Mounted Design', 'Planning Drawings'],
    challenge:
      'A logistics property company sought to install rooftop solar across seven warehouse and distribution centre sites in Greater Dublin simultaneously. Building ages ranged from 1985 to 2018, with varying roof structure types, load capacities, and planning exemption statuses.',
    solution:
      'We conducted structural surveys of all seven roofs and categorised them by intervention level required. Five sites were confirmed exempt from planning permission; two required a planning application due to roof strengthening works. We produced standardised drawing templates to reduce design time and costs across the portfolio.',
    outcome:
      'All seven sites received necessary approvals. Total installed capacity of 8.4MW. Uniform documentation across the portfolio simplified insurance and warranty administration significantly.',
    stats: {
      capacity: '8.4MW',
      panels: '16,800',
      sites: '7',
      planningDuration: '6 weeks',
    },
    tags: ['Rooftop', 'Commercial', 'Portfolio', 'Dublin'],
    image: '/images/case-study-3.jpg',
    year: 2024,
  },
  {
    id: 4,
    slug: 'airport-proximity-glint-glare',
    title: 'Airport Proximity — Complex Glint & Glare Case',
    county: 'Clare',
    projectType: 'Ground-Mounted Solar Farm',
    capacity: '22MW',
    services: ['Glint & Glare Analysis', 'Planning Drawings'],
    challenge:
      'A 22MW solar farm within 8km of a regional airport required detailed glint and glare assessment in accordance with Irish Aviation Authority (IAA) guidelines. Initial indicative modelling suggested potential impacts on two approach flight paths.',
    solution:
      'We conducted a full IAA-protocol glint and glare assessment including sun-path modelling across all panel orientations and tilt angles. By adjusting panel tilt from 30° to 25° and specifying anti-reflective glass with a surface reflectance below 4%, we eliminated all impacts on the flight paths without reducing energy yield by more than 2%.',
    outcome:
      'IAA issued no objection. Planning authority approved the application subject to the anti-reflective glass specification being secured as a planning condition, which we had anticipated and pre-drafted.',
    stats: {
      capacity: '22MW',
      panels: '44,000',
      homesSupplied: '5,900',
      planningDuration: '20 weeks',
    },
    tags: ['Aviation', 'Glint & Glare', 'Ground-Mounted', 'Complex Case'],
  ...
  {
    id: 6,
    slug: 'community-solar-cork',
    title: 'Community Solar Scheme — Cork Rural',
    county: 'Cork',
    projectType: 'Ground-Mounted Solar Farm',
    capacity: '5MW',
    services: ['Ground-Mounted Design', 'Planning Drawings', 'Landscape Plan'],
    ...
    stats: {
      ...
      panels: '10,000',
      homesSupplied: '1,350',
      planningDuration: '12 weeks',
    },
    tags: ['Community Solar', 'Rural', 'Small Scale', 'Cork'],
